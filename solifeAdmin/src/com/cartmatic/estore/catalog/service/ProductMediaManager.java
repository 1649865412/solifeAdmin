...
public interface ProductMediaManager extends GenericManager<ProductMedia> {
	 ...
	 * @param mediaProductSkus
	 * @param productMedia_deleteds 
	 * @return返回新增媒体的Id，原负id_新id
	 */
	public List<String> saveProductMedias(Integer productId,String[]productMediaIds,String[]productMediaTypes,String []mediaUrls, String[] mediaUrls_d, String []mediaDescription, String []mediaProductSkus ,String productMedia_deleteds[]);
